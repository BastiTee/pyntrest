...
class IoTestSuite(unittest.TestCase):
    ...
    def test_read_optional_album_metadata (self):
        ...
        self.assertRaises(TypeError, pyntrest_io.read_optional_album_metadata, 'asdasd_:asd', '')
        a, b, c, d, e, f = pyntrest_io.read_optional_album_metadata('', pyntrest_core.META_INI_FILE_PATTERN)
        ...
        a, b, c, d, e, f = pyntrest_io.read_optional_album_metadata(dirname, pyntrest_core.META_INI_FILE_PATTERN )
